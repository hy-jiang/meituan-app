  ...
  <div class="page-login">
    ...
    <div class="login-panel">
      ...
      <div class="form">
        ...
        <el-input :class="{error: error&&!userName}" v-model="userName" placeholder="手机号/用户名/邮箱" prefix-icon="profile">
        ...
        <div class="oauth-wrapper J-oauth-wrapper">
          ...
          <div class="oauth cf">
            <a class="oauth__link oauth__link--qq third-login-btn" data-href="/account/connect/tencent" target="_blank"
              id="J-third-tencent"></a>
            <a class="oauth__link oauth__link--weibo third-login-btn" data-href="/account/connect/sina" target="_blank"
              id="J-third-sina"></a>
          </div>
